...
;; markdown-mode, simple-httpd and impatient-mode are now declared in init.el
;; (section 10), so that every straight.el recipe lives in one place and this file
;; stays pure logic.  It is loaded after them, so they are already present.
